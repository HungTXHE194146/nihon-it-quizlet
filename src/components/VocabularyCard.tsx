  ...
  return (
    <div className="w-full max-w-xl mx-auto">
      ...
      <div className="mb-4 flex items-center justify-between">
        <span className="text-xs font-bold text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-950/40 px-2.5 py-1 rounded-full uppercase tracking-wide flex items-center gap-1.5">
      ...
      <div className="perspective-1000 w-full h-[340px] md:h-[360px] relative select-none">
        ...
        >
          {/* FRONT FACE */}
          <div className="absolute inset-0 w-full h-full backface-hidden rounded-2xl border-2 border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-xl shadow-slate-100/40 dark:shadow-none p-6 md:p-8 flex flex-col justify-between cursor-pointer hover:border-indigo-300 dark:hover:border-indigo-600 transition-all duration-300">
            <div className="flex items-center justify-between gap-2">
              {ttsSupported && spokenText ? (
                <button
                  ...
                  className="p-2 rounded-xl bg-sky-50 dark:bg-sky-950/40 text-sky-600 dark:text-sky-400 border border-sky-100 dark:border-sky-800 hover:bg-sky-100 dark:hover:bg-sky-900/60 active:scale-95 transition-all cursor-pointer shadow-sm"
              ...
              {mode === 'write-kanji' ? (
                <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-amber-100 dark:bg-amber-950/40 text-[10px] font-black text-amber-800 dark:text-amber-300 uppercase tracking-wider border border-amber-200 dark:border-amber-800">
                  ✍️ Tập viết Chữ Hán
                </span>
              ) : mode === 'type-reading' ? (
                <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-violet-100 dark:bg-violet-950/40 text-[10px] font-black text-violet-800 dark:text-violet-300 uppercase tracking-wider border border-violet-200 dark:border-violet-800">
                  ⌨️ Gõ cách đọc
                </span>
              ) : (
                <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-indigo-50 dark:bg-indigo-950/40 text-[10px] font-bold text-indigo-600 dark:text-indigo-400 uppercase tracking-wider">
                  Từ vựng
                </span>
              )}
            </div>
            ...
            <div className="text-center my-auto flex flex-col items-center justify-center w-full">
              {mode === 'type-reading' ? (
                <>
                  ...
                  <h2 className="text-4xl md:text-5xl font-black text-slate-800 dark:text-slate-100 leading-tight mb-4 select-text">
                    {item.term}
                  </h2>
                  ...
                  >
                    <input
                      ...
                      spellCheck={false}
                      lang="ja"
                      className="w-full text-center text-lg font-bold py-3 px-4 rounded-2xl border-2 border-violet-200 dark:border-violet-800 bg-violet-50/40 dark:bg-violet-950/30 text-slate-800 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 placeholder:font-semibold placeholder:text-sm focus:outline-none focus:border-violet-500 dark:focus:border-violet-500 focus:bg-white dark:focus:bg-slate-900 transition-all disabled:opacity-60"
                    />

                    {/* Xem trước chuyển đổi romaji, để người gõ chữ La-tinh biết mình ra kana gì */}
                    <div className="h-6 mt-2 flex items-center justify-center">
                      {typed && /[a-zA-Z]/.test(typed) && (
                        <span className="text-xs font-bold text-violet-700 dark:text-violet-300 bg-violet-100 dark:bg-violet-900/40 px-2.5 py-1 rounded-lg border border-violet-200 dark:border-violet-800">
                          {romajiToHiragana(typed) || '...'}
                        </span>
                      )}
                    </div>

                    <p className="mt-1 text-[11px] font-bold text-slate-400 dark:text-slate-500 flex items-center justify-center gap-1.5">
                ...
                <>
                  ...
                  <h2 className="text-4xl md:text-5xl font-black text-rose-600 dark:text-rose-400 leading-tight mb-2 select-text">
                    {item.reading || item.term}
                  </h2>
                  <div className="mt-4 px-3.5 py-1.5 rounded-xl bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800 text-amber-900 dark:text-amber-200 text-xs font-bold flex items-center gap-1.5">
                ...
                <>
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold text-slate-800 dark:text-slate-100 leading-tight mb-2 select-text">
                    {item.term}
                  </h2>
                  ...
                  {item.reading && (
                    <div className="mt-2 h-12 flex items-center justify-center">
                      {showHira ? (
                        <p className="text-slate-500 dark:text-slate-400 font-semibold text-sm md:text-base select-text flex items-center gap-1.5 bg-slate-50 dark:bg-slate-900 px-3 py-1.5 rounded-lg border border-slate-200/50 dark:border-slate-700/50 animate-fadeIn">
                          ...
                          <button
                            ...
                            className="p-1 rounded-md text-slate-400 dark:text-slate-500 hover:text-rose-500 dark:hover:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/40 transition-colors cursor-pointer"
                            title="Ẩn cách đọc"
                          >
                            <EyeOff size={14} />
                          </button>
                        ...
                        <button
                          ...
                          className="text-xs font-bold text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 bg-indigo-50 dark:bg-indigo-950/40 hover:bg-indigo-100/80 dark:hover:bg-indigo-900/60 px-3 py-2 rounded-lg border border-indigo-100 dark:border-indigo-800 flex items-center gap-1.5 active:scale-95 transition-all cursor-pointer shadow-sm"
                        >
                          <Eye size={12} />
          ...
          {/* BACK FACE */}
          <div className="absolute inset-0 w-full h-full backface-hidden rounded-2xl border-2 border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-xl shadow-slate-100/40 dark:shadow-none rotate-y-180 p-6 md:p-8 flex flex-col justify-between cursor-default">
            <div className="text-right flex justify-between items-center">
              <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-emerald-50 dark:bg-emerald-950/40 text-[10px] font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-wider">
              ...
              {ttsSupported && spokenText && (
                <button
                  ...
                  className="ml-auto mr-1.5 p-1.5 rounded-lg text-sky-600 dark:text-sky-400 hover:bg-sky-50 dark:hover:bg-sky-950/40 transition-colors cursor-pointer"
                  title="Nghe phát âm (phím S)"
                  aria-label="Nghe phát âm"
                >
                  <Volume2 size={16} />
              ...
              <button
                ...
                disabled={isGraded}
                className="p-1.5 rounded-lg text-slate-400 dark:text-slate-500 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors disabled:opacity-40"
            ...
            <div className="text-center my-auto flex flex-col items-center justify-center-safe overflow-y-auto max-h-[190px] py-2 px-1 w-full">
              {mode === 'type-reading' ? (
                <>
                  ...
                  <h3 className="text-3xl md:text-4xl font-black text-slate-800 dark:text-slate-100 leading-tight select-text">
                    {item.term}
                  </h3>
                  <p className="mt-1 text-lg font-extrabold text-violet-700 dark:text-violet-400 select-text">
                    {item.reading}
                  </p>
                  {selectedGrade === 'incorrect' && typed.trim() && (
                    <p className="mt-1 text-xs font-bold text-slate-400 dark:text-slate-500">
                      Bạn gõ: <span className="text-rose-600 dark:text-rose-400">{typed}</span>
                    </p>
                  )}
                ...
                <>
                  <h3 className="text-4xl md:text-5xl font-black text-slate-800 dark:text-slate-100 leading-tight select-text mb-2">
                    {item.term}
                  </h3>
                  <div className="flex items-center gap-2 text-sm font-bold text-slate-500 dark:text-slate-400">
                    {item.reading && <span className="bg-slate-100 dark:bg-slate-700 px-2 py-0.5 rounded border border-slate-200 dark:border-slate-600">[{renderFormattedText(item.reading)}]</span>}
                    <span>{renderFormattedText(item.meaning || item.answer || "")}</span>
                  </div>
                </>
              ) : (
                <h3 className="text-2xl md:text-3xl font-extrabold text-slate-800 dark:text-slate-100 leading-tight select-text">
                  {renderFormattedText(item.meaning || item.answer || "")}
                </h3>
              )}
              {item.explanation && (
                <div className="mt-3 p-3 bg-slate-50 dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 text-left text-xs md:text-sm text-slate-500 dark:text-slate-400 max-w-md w-full select-text whitespace-pre-line">
                  <span className="font-bold text-slate-700 dark:text-slate-200 block mb-0.5">Giải thích:</span>
                ...
                <div className="mt-3 w-full flex flex-col items-center">
                  {!showExample ? (
                    <button
                      ...
                      className="text-xs font-bold text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 bg-indigo-50 dark:bg-indigo-950/40 hover:bg-indigo-100 dark:hover:bg-indigo-900/60 px-3 py-1.5 rounded-lg border border-indigo-100 dark:border-indigo-800 flex items-center gap-1.5 transition-all cursor-pointer shadow-sm active:scale-95"
                    >
                      <Eye size={12} />
                      <span>Xem câu ví dụ (例文)</span>
                    </button>
                  ) : (
                    <div className="p-3 bg-indigo-50/90 dark:bg-indigo-950/40 rounded-xl border border-indigo-200/80 dark:border-indigo-800 text-left text-xs md:text-sm text-indigo-950 dark:text-indigo-200 max-w-md w-full select-text animate-fadeIn">
                      <div className="flex items-center justify-between mb-1.5">
                        <span className="font-extrabold text-indigo-700 dark:text-indigo-300 flex items-center gap-1 text-[11px] uppercase tracking-wider">
                          💡 Ví dụ (例文):
                          {ttsSupported && (
                            <button
                              onClick={(e) => {
                              ...
                              className="ml-1 p-1 rounded text-sky-600 dark:text-sky-400 hover:bg-white/70 dark:hover:bg-slate-900/60 transition-colors cursor-pointer"
                        ...
                        <button
                          ...
                          className="text-[10px] font-bold text-slate-500 dark:text-slate-400 hover:text-indigo-700 dark:hover:text-indigo-300 bg-white/90 dark:bg-slate-900/70 px-2 py-0.5 rounded border border-indigo-100 dark:border-indigo-800 cursor-pointer"
                        >
                          Ẩn ví dụ
                        </button>
                      </div>
                      <p className="font-medium whitespace-pre-line leading-relaxed text-slate-800 dark:text-slate-200">
        ...
        {mode === 'type-reading' ? (
          ...
          !isGraded && (
            <button
              ...
              className="px-6 py-3 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-slate-700 rounded-xl font-bold hover:bg-slate-200 dark:hover:bg-slate-700 active:scale-95 transition-all flex items-center gap-2 cursor-pointer"
            >
              <Eye size={16} />
          ...
          <button
            onClick={handleFlip}
            className="px-6 py-3 bg-indigo-600 text-white rounded-xl font-bold hover:bg-indigo-700 active:scale-95 transition-all shadow-md shadow-indigo-100 dark:shadow-none flex items-center gap-2 cursor-pointer"
          >
